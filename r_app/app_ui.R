...
intro_page <- tabPanel(
  ...
  p(tags$ul(
    tags$li(strong("Health Indicators - how to define health inequality?"),
    ...
    tags$li(strong("Debts - how much debts are these “Global South” countries facing?"),
    ...
    tags$li(strong("Austerity - How were paying back debts influence the health system?"),
  ...
  p(tags$ul(
    tags$li(a(" “Racial Inequities Persist in Health Care Despite Expanded Insurance”",
              href = "https://www.nytimes.com/2021/08/17/health/racial-disparities-health-care.html"
    ),
    "- New York Times, Roni Caryn Rabin"
    ),
    tags$li(a("“Aid in reverse: how poor countries develop rich countries”",
    ...
    tags$li(a("“END AUSTERITY, A Global Report on Budget Cuts and Harmful Social Reforms in 2022-25”",
  ...
  p(tags$ol(
    tags$li("To define the inequality: compared to other countries that have no or little debt, how much money, or what percentage of the government compensation are spent on healthcare that are suffering from international debts?"),
    tags$li("For the “Global South” country, compared to money spent on debts, how much money, or what percentage of the government compensation are spent on healthcare?"),
    tags$li("For the “Global South” country, how insufficient are they in the perspective of the health system?"),
    tags$li("What is the standard level of health resource for a country to equip?")
  )),
  h2("Data"),
  p(""),
  h2("Key Findings"),
