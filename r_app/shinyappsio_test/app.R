...
# Define UI for application _____________________________________________________
### Sourcing ###
source("../shinyappsio_test/chart_2.R")
source("../shinyappsio_test/MMR.R")
source("../shinyappsio_test/per capital.R")
